...
class MemListSerializer(HyperlinkedModelSerializer):
    ...
    class Meta:
        model = MembraneTopol
        fields = [ 'details', 'name', 'tags', 'lipid_species', 'lipids', 'forcefield', 'membrane_file', 'composition_file' ]
...
class TopolCompositionSerializer(HyperlinkedModelSerializer):
    ...
    def get_proportion(self, topol):
        ...
        return round(topol.number*100/total_number, 1) if total_number != None else 0.0
...
class MemDetailSerializer(HyperlinkedModelSerializer):
    ...
    class Meta:
        model = MembraneTopol
        fields=[ 
            'name', 'lipid_species', 'lipids', 'forcefield', 'software', 'membrane_file', 'composition_file',
